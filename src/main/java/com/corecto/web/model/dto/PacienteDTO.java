...
public class PacienteDTO {
	...
	public PacienteDTO(long idpaciente, int idos, String nombreOs,
			String nombre, String sexo, String fechanac, String domicilio,
			String telefono, String mail,
			String nroOs, String notas, String peso, String talla,
			String supcorporal, String performanceStatus, String tactoRectal,
			String tactoRectalInfiltra, String rsc, String rscAltura,
			String rscFecha, String vcc, String vccAltura, String vccFecha,
			String ee, String eeInfiltra, String eeFecha) {
		super();
		this.idpaciente = idpaciente;
		this.idos = idos;
		this.nombreOs = nombreOs;
