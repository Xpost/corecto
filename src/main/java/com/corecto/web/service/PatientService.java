...
public interface PatientService {
	...
	//
	// List<ClienteDTO> listClientsByParameters(String name, String lastName,
	// String cuit, String score, String fieldOrder, String order);
	//
	Map<String, Object> loadAllAddPatientCat();

	long savePatient(PacienteDTO pacienteDTO);

	List<PacienteDTO> listPatients(String name, Long patientID, String direction);
