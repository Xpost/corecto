 ...
 * @version 1.0
 */
public class EstadificacionDAOImpl extends HibernateDaoSupport implements EstadificacionDAO {
	...
	public Estadificacion loadEstadificacionById(final Long idestadificacion) throws DataAccessException {
		...
		List<Estadificacion> listResult = (List<Estadificacion>) getHibernateTemplate().find(
				"select C from Estadificacion as C where C.idestadificacion=" + idestadificacion);
	...
	public Estadificacion loadEstadificacionByConsulta(final Long idconsulta) throws DataAccessException {
		...
		List<Estadificacion> listResult = new ArrayList<Estadificacion>();
		HibernateCallback callback = new HibernateCallback() {

			public Object doInHibernate(Session session) throws HibernateException {

				Query query = session.createQuery("select P " + " FROM Estadificacion as P, Consulta as C "
