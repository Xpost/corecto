 ...
 * @version 1.0
 */
public class AntecedentesDAOImpl extends HibernateDaoSupport implements AntecedentesDAO {
	...
	public long saveNewAntecedentes(Antecedentes antecedentes) throws DataAccessException {
		...
		return antecedentes.getIdantecedente();
	}

	public long updateAntecedentes(Antecedentes antecedentes) throws DataAccessException {
		LOG.info("MotivoDAOImpl.updateAntecedentes()");
		getHibernateTemplate().update(antecedentes);
		return antecedentes.getIdantecedente();
	}
