 ...
 * @version 1.0
 */
public class RespuestaTrataNeoDAOImpl extends HibernateDaoSupport implements RespuestaTrataNeoDAO {
	...
	public RespuestaTrataNeo loadRespuestaTrataNeoById(final Long idrespuestatrataneo)
		...
		List<RespuestaTrataNeo> listResult = (List<RespuestaTrataNeo>) getHibernateTemplate().find(
				"select C from RespuestaTrataNeo as C where C.idrespuestatrataneo=" + idrespuestatrataneo);
	...
	public RespuestaTrataNeo loadRespuestaTrataNeoByConsulta(final Long idconsulta)
		...
		List<RespuestaTrataNeo> listResult = new ArrayList<RespuestaTrataNeo>();
		HibernateCallback callback = new HibernateCallback() {

			public Object doInHibernate(Session session) throws HibernateException {

				Query query = session.createQuery("select P "
						+ " FROM RespuestaTrataNeo as P, Consulta as C "
		...
		listResult = (List<RespuestaTrataNeo>) this.getHibernateTemplate().execute(callback);
