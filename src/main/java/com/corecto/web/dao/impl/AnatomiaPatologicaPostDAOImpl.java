...
public class AnatomiaPatologicaPostDAOImpl extends HibernateDaoSupport implements AnatomiaPatologicaPostDAO {
	...
	public long saveNewAnatomiaPatologicaPost(AnatomiaPatologicaPost anatomiaPatologicaPost)
	...
	public long updateAnatomiaPatologicaPost(AnatomiaPatologicaPost anatomiaPatologicaPost)
			throws DataAccessException {
	...
	public AnatomiaPatologicaPost loadAnatomiaPatologicaPostById(final Long idanatomiapatopost)
			throws DataAccessException {

		List<AnatomiaPatologicaPost> listResult = (List<AnatomiaPatologicaPost>) getHibernateTemplate().find(
